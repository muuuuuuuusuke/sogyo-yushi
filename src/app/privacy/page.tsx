...
export const metadata: Metadata = {
  title: "プライバシーポリシー",
  description: "当サイトにおける入力値・アクセス解析・広告の取り扱いについて。",
};

export default function PrivacyPage() {
  return (
    <main className="mx-auto w-full max-w-2xl space-y-4 px-5 py-12 text-[0.8125rem] leading-7 text-ink-soft sm:py-16">
      <h1 className="display text-[clamp(1.65rem,5vw,2.4rem)] text-ink">プライバシーポリシー</h1>

      <h2 className="display !mt-12 text-xl text-ink">入力された金額の扱い</h2>
      <p>
        計算はすべて閲覧者のブラウザ内で完結します。入力された借入額・金利などが
        当サイトのサーバーへ送信されることはなく、保存もしません。
      </p>
      ...
      <p>
        当サイトの計算結果・制度情報は参考情報であり、融資の可否や条件を保証するものではありません。
        借入の判断はご自身の責任で、金融機関・専門家への確認のうえ行ってください。
      </p>
